 ...
 */
export const SurfaceConstructionViewAndEditTable = <T extends { id: string }>(
  props: TTableProps<T>,
) => {
                ...
                <Table.Td key={cell.id}>
                  {cell.column.id === "layers" ? (
                    <div className="truncate">
                      <div className="scrollbar-none flex gap-1.5 overflow-x-auto pr-2">
                        {(() => {
                          ...
                          return items.map((text, idx) => (
                            <p
                              className="bg-neutral240 rounded-md px-2 py-1.5 text-sm font-medium whitespace-nowrap text-white"
                              key={idx}
                              title={text}
                            >
                              {text}
